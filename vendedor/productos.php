...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
	...
	<input type="image" src="/images/Panel/impresora.png" width="55" height="50" name="Submit" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm" value="Imprimir" onclick="javascript:window.print()">
</div>
<div class="row">
    <div class="col-md-12">
